...
function confidenceColor(signal: string) {
  ...
  if (s.includes("BUY")) return "bg-green-600/90 text-white border border-green-400/30";
  if (s.includes("SELL")) return "bg-red-600/90 text-white border border-red-400/30";
...
export default function Bot24Dashboard() {
  ...
  return (
    <div className="max-w-7xl mx-auto py-10 px-4 space-y-10 bg-[url('/hero-b.webp')] bg-cover bg-center">
      {/* HEADER */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-[#111] border border-white/10 p-8 rounded-3xl">
          ...
          {!loading && heatmap.length === 0 && (
            <p className="text-gray-500 text-sm">Dados do mercado indisponíveis.</p>
          )}
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {heatmap.map(item => (
              ...
              >
                ...
                <span className="text-xs uppercase opacity-80">{item.signal}</span>
