  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-6 space-y-8">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-3xl font-black tracking-tighter text-white">MY ACCOUNT</h1>
      </div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            <div className="bg-gray-900 border border-gray-800 p-6 rounded-3xl shadow-xl flex flex-col gap-3">
        ...
        <div className="bg-gray-900 p-10 rounded-3xl text-center border border-gray-800">
