...
export default function Register() {
  ...
  return (
    ...
    <main className="min-h-screen bg-[#0d0d0d] flex items-center justify-center px-6 py-17">
        ...
        <div className="bg-[#0d0d0d] border border-blue-400/20 rounded-3xl p-10 shadow-[0_0_35px_rgba(59,130,246,0.25)] backdrop-blur-xl">
            ...
            <>
              ...
              >
                ...
                <svg width="18" height="18" viewBox="0 0 48 48">
                  ...
                  <path fill="#EA4335"
                    d="M24 9.5c3.54 0 6.71 1.22 9.21 3.6l6.85-6.85C35.9 2.54 30.33 0 24 0
                    14.64 0 6.5 5.48 2.56 13.44l7.98 6.2C12.24 13.28 17.67 9.5 24 9.5z"/>

                  <path fill="#4285F4"
                    d="M46.5 24.5c0-1.63-.15-3.2-.43-4.72H24v9h12.7
                    c-.55 2.97-2.22 5.48-4.73 7.18l7.27 5.66
                    C43.87 37.43 46.5 31.52 46.5 24.5z"/>

                  <path fill="#FBBC05"
                    d="M10.54 28.64a14.5 14.5 0 010-9.28l-7.98-6.2A23.97
                    23.97 0 000 24c0 3.77.9 7.34 2.56 10.84l7.98-6.2z"/>

                  <path fill="#34A853"
                    d="M24 48c6.48 0 11.93-2.14 15.9-5.82l-7.27-5.66
                    c-2.02 1.35-4.6 2.14-8.63 2.14
                    -6.33 0-11.76-3.78-13.46-9.14l-7.98 6.2C6.5 42.52
                    14.64 48 24 48z"/>
          ...
          {success ? (
            ...
            <div className="space-y-6">
              ...
              <div className="text-center text-sm text-gray-400">
                ...
                <Link
                  href="/auth/login"
                  className="ml-2 text-white font-semibold hover:text-gray-300"
                >
                  Ir para login
                </Link>
          ...
          {!success && (
            ...
            <div className="mt-10 pt-6 border-t border-white/10 text-center text-sm text-gray-400">
              ...
              <Link
                href="/auth/login"
                className="ml-2 text-white hover:text-gray-300 font-semibold transition"
              >
                Entrar
              </Link>
